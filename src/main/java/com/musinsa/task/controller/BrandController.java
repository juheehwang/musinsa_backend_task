...
public class BrandController {
    ...
    @PostMapping
    public ResponseEntity<?> addBrand(@RequestBody @Valid BrandInsertRequest insertRequest){
        return ResponseEntity.ok(brandService.addBrand(insertRequest));
    }

    @Operation(summary = "브랜드 수정")
    @PutMapping
    public ResponseEntity<?> updateBrand(@RequestBody @Valid BrandUpdateRequest updateRequest) {
        return ResponseEntity.ok(brandService.updateBrand(updateRequest));
    }

    @Operation(summary = "브랜드 삭제")
    @DeleteMapping
    public ResponseEntity<?> deleteBrand(@RequestBody @Valid BrandDeleteRequest deleteRequest) {
